...
aggr_func
  ...
  / aggr_fun_list
  / aggr_fun_stddev_stddevsamp_stddevpop
  / aggr_fun_variance_varsamp_varpop
  / aggr_fun_xmlagg
...
aggr_fun_stddev_stddevsamp_stddevpop
	= name:(KW_STDDEV? __ KW_STDDEV_POP? __ KW_STDDEV_SAMP? / KW_GROUP_CONCAT) __ LPAREN __ arg:stddev_stddevsamp_stddevpop_arg __ RPAREN __ bc:over_partition? {
      return {
        type: 'aggr_func',
        name: name,
        args: arg,
...
aggr_fun_variance_varsamp_varpop
	= name:(KW_VARIANCE? __ KW_VAR_SAMP? __ KW_VAR_POP? / KW_GROUP_CONCAT) __ LPAREN __ arg:variance_varsamp_varpop_arg __ RPAREN __ bc:over_partition? {
      return {
        type: 'aggr_func',
        name: name,
        args: arg,
...
aggr_fun_xmlagg
	= name:(KW_XMLAGG / KW_GROUP_CONCAT) __ LPAREN __ arg:xmlagg_arg __ RPAREN __ bc:over_partition? {
      return {
        type: 'aggr_func',
        name: name,
        args: arg,
...
aggr_fun_json_arrayagg
  = name:(KW_JSON_ARRAYAGG / KW_GROUP_CONCAT) __ LPAREN __ arg:json_arrayagg_arg __ RPAREN __ bc:over_partition? {
      return {
        type: 'aggr_func',
        name: name,
        args: arg,
...
aggr_fun_list
  = name:(KW_LIST / KW_GROUP_CONCAT) __ LPAREN __ arg:list_arg __ RPAREN __ bc:over_partition? {
      return {
        type: 'aggr_func',
        name: name,
        args: arg,
...
stddev_stddevsamp_stddevpop_arg
...
xmlagg_arg
	 = e:star_expr { return { expr: e }; }
  / d:KW_DISTINCT? __ KW_BY? __ LPAREN __ c:expr __ RPAREN __ or:order_by_clause? __ s:concat_separator? { return { distinct: d, expr: c, orderby: or, parentheses: true, separator: s }; }
  / KW_ALL? __ LPAREN __ c:expr __ RPAREN __ or:order_by_clause? __ s:concat_separator? { return { expr: c, orderby: or, parentheses: true, separator: s }; }
  / d:KW_DISTINCT? __ c:expr __ or:order_by_clause? __ s:concat_separator? { return { distinct: d, expr: c, orderby: or, separator: s }; }
  / KW_ALL? __ c:expr __ or:order_by_clause? __ s:concat_separator? { return { expr: c, orderby: or, separator: s }; }
  / KW_XMLELEMENT? __ LPAREN __ c:expr __ RPAREN __ or:order_by_clause? __ s:concat_separator? { return { expr: c, orderby: or, parentheses: true, separator: s }; }
  / KW_XMLELEMENT? __ c:expr __ or:order_by_clause? __ s:concat_separator? { return { expr: c, orderby: or, separator: s }; }		
